...
function AccessibleTable() {
  ...
  return (
    <TableContainer component={Paper}>
      <Table
        style={{ maxWidth: "100%", overflowX: "auto", height: "450px" }}
        aria-label="caption table">
        <TableHead>
          <TableRow>
            <TableCell> 30 - NOV - 2024</TableCell>
            <TableCell align="center">Indoor Court A </TableCell>
            <TableCell align="center">Indoor Court B</TableCell>
            <TableCell align="center">Outdoor&nbsp;(6v6) </TableCell>
            <TableCell align="center">Outdoor&nbsp;(11v11)</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.name}>
              ...
              <TableCell align="center">{row.timeAvailibilty_1}</TableCell>
              <TableCell align="center">{row.timeAvailibilty_2}</TableCell>
              <TableCell align="center">{row.timeAvailibilty_3}</TableCell>
              <TableCell align="center">{row.timeAvailibilty_4}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
